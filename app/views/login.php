			...
			<div class="card">
				...
				<div class="card-body">
					...
					<?php if(isset($_GET["statut"])): ?>
						...
						<?php if($_GET["statut"] == 'apprenant' || $_GET["statut"] == 'intervenant' || $_GET["statut"] == 'responsable'): ?>
					...
					<?php else: ?>
						...
						<div class="list-group">
							<a href="index.php?page=login&statut=apprenant" class="list-group-item list-group-item-action">Apprenant</a>
							<a href="index.php?page=login&statut=intervenant" class="list-group-item list-group-item-action">Intervenant</a>
							<a href="index.php?page=login&statut=responsable" class="list-group-item list-group-item-action">Responsable</a>
						</div>
